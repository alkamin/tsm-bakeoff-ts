...
const App: React.FC = () => {
  const collection = {
    ...
    "id": "berlin",
    "title": null,
    "description": "Pixel masks for buildings in Berlin generated using Deeplab and other AI algorithms with Sentinel 2",
    "keywords": [],
    "license": "proprietary",
    "providers": [],
    "extent": {
  ...
  const { value, error, loading } = useAsync<typeof collection>(
    async () => {
